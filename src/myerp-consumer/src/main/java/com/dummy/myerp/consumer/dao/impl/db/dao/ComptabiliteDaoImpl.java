...
public class ComptabiliteDaoImpl extends AbstractDbConsumer implements ComptabiliteDao {
    ...
    /** SQLupdateDernierValeurSequenceEcritureComptableByJournalCode*/
    private static String SQLupdateDerniereValeurSequenceEcritureComptableByJournalCode;
    public void setSQLupdateDerniereValeurSequenceEcritureComptableByJournalCode(String pSQLupdateDerniereValeurSequenceEcritureComptableByJournalCode) {
        SQLupdateDerniereValeurSequenceEcritureComptableByJournalCode = pSQLupdateDerniereValeurSequenceEcritureComptableByJournalCode;
    }

    @Override
    public void updateDerniereValeurSequenceEcritureComptableByJournalCode(Integer pDerniereValeur, String pJournalCode) {
        NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
